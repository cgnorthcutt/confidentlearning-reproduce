...
base = '/home/cgn/cgn/confidentlearning-reproduce/cifar10/confidentlearning_and_coteaching/results/'
...
for noise in [2, 4, 6]:
    for sparsity in [0, 2, 4, 6]:
        ...
        for experiment in experiments:
            path = base + "/" + f + "/" + experiment + "/out_" + f + ".log"
...
print(cifar10_final_benchmarks.round(3).to_latex())
