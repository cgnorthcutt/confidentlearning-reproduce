    ...
    def __init__(
        ...
        if self.train:
            ...
            if noise_type !='clean':
                ...
                self.train_noisy_labels, self.train_data, self.actual_noise_rate, self.class_weights = noisify(
                ...
                self.noise_or_not = np.asarray([_train_labels[i] == v for i, v in enumerate(self.train_noisy_labels)])
        else:
